...
<body>
                    ...
                    <ul class="nav navbar-nav d-flex justify-content-between mx-xl-5 text-center text-dark">
                        <li class="nav-item">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown">
                                <a class="nav-link btn-outline-primary rounded-pill px-3" href="evenements.html" >Evenements</a>
                                <div class="dropdown-content">
    ...
    <section class="service-wrapper py-3">
        <div class="container-fluid pb-3">
            <div class="row">
                <h2 class="h2 text-center col-12 py-5 semi-bold-600">Current Events</h2>
                    ...
                    <a href="front_ticket.php?T_IDE=<?php echo $data['ide'] ?>" class="recent-work card border-0 shadow-lg overflow-hidden">
                        ...
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                                ...
                                <p class="card-title light-300"><h6><?php  echo $data['description'];?> </h6><br> <h5> <?php echo $data['date_d']; ?> ---> <?php echo $data['date_f']; ?></h6></p>
                            </div>
                        </div>
                    </a>
                </div><!-- End Recent Work -->
