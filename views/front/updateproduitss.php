<?php
    ...
    require_once 'C:/xampp/htdocs/integration/entities/panier.php';
...
<head>
    ...
    <link rel="stylesheet" href="/integration/assets/css/magnify.css">
  ...
  $('.zoom').magnify();
	...
	<section class="container">
		...
		<div class="form-container">
            ...
            <img src="/integration/assets/img/<?= $result['imagePr'] ?>"  width = "200" height = "200" id="imagePr" class="zoom" data-magnify-src="/integration/assets/img/<?= $result['imagePr'] ?>" > 
...
?>
    ...
    <script src="/integration/assets/js/jquery.magnify.js"></script>
