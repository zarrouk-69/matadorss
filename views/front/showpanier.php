<?php
    ...
    if (isset($_POST['valider']) ) {
      /* if ($result11 !== false) */{
                ...
                <td> <img src="/integration/assets/img/<?= $result11['image'] ?>" width = "50" height = "50" class="shop-item-image"> </td>
        ...
        <br>
           ...
           /* if ($result11 !== false) */{
                   ?>
                     ...
                     <tr>
                     <td><a class="nav-link" href="showpanier.php?idprec=<?= $panier['idprec'] ?>"><i class="fas fa-trash"></i></a></td>   
                     <td> <img src="/integration/assets/img/<?= $result11['imagePr'] ?>" width = "50" height = "50" class="shop-item-image"> </td>
