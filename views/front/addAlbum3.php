<?php
    ...
    if (isset($_POST['nom']) && isset($_POST['age']) && isset($_POST['image']) && isset($_POST['descriptionA'])) {
        $animal = new animal($_POST['nom'], $_POST['age'], $_POST['image'], $_POST['descriptionA']);
                ...
                <div class="flex-fill mx-xl-5 mb-2">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-xl-5 text-center text-dark">
                        <li class="nav-item">
                            ...
                            <div class="dropdown">
                                <a class="nav-link btn-outline-primary rounded-pill px-3" href="showAlbums.php">Animaux</a>
        ...
        <div class="container">
            <div class="row d-flex align-items-center py-5">
                <div class="col-lg-6 text-start">
                    <h1 class="h2 py-5 text-primary typo-space-line">Animaux</h1>
    <a href = "searchAlbum.php" class="btn btn-primary shop-item-button">Search</a>
	<section class="container">
		<h2>New Animal</h2>
        <a href = "showAlbums3.php" class="btn btn-primary shop-item-button">All animals</a>
