...
require_once 'C:/xampp/htdocs/integration/controller/animalA.php';
    ...
    if (isset($_POST['nom']) && isset($_POST['age']) && isset($_POST['image'])) {
        $animal = new animal($_POST['nom'], $_POST['age'], $_POST['image']);
...
<!-- Header -->
    ...
    <!-- Close Header -->
    <a href = "searchAlbum3.php" class="btn btn-primary shop-item-button">Search</a>
    <?php
