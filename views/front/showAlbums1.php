...
<map name="workmap">
  ...
  <area shape="rect" coords="20,50,44,300" alt="Cup of coffee" href="zone1.php">
</map>
</div>  
		<section class="container">
			...
			<meta name="viewport" content="width=device-width, initial-scale=1">
				...
				<div class="col-3">
					...
					<h>Nom: </h><strong class="shop-item-title"> <?= $site  ['nomS'] ?> </strong>
					<img class="card-img-top" src="../.././assets/img/<?= $site['imageS'] ?>" width = "200" height = "200" class="shop-item-image">
				</div>
	            <div class="card-body">
						<h><strong> Description: </strong></h> <span class="shop-item-price"><?= $site ['descS'] ?> </span>
