...
<body>
  ...
  <div class="main-content" id="panel">
	...
	<a href = "searchAlbum4.php" class="btn btn-warning mb-2">Rechercher</a>
<form action="" method="POST">
    ...
    <a><input  class="btn btn-outline-danger"type = "submit" name = "TrierDesc" value ="TrierDesc"></a>
		...
		<section class="container">
			...
			<h2>Animaux</h2>
      <a href = "addAlbum4.php" class="btn btn-primary" href = "#">Ajouter</a>
            <div class="row">
			<meta name="viewport" content="width=device-width, initial-scale=1">
				...
				<div class="card" style="width: 18rem;">
					...
					<img class="card-img-top" src="../.././assets1/img/<?= $animal['image'] ?>" width = "200" height = "200" class="shop-item-image">
			    </div>
                <div class="card-body">
          
						<h>Age: </h><strong  class="shop-item-price"><?= $animal['age'] ?> ans </strong>
                </div>
						<a type="button" class="btn btn-success mb-2" href = "updateAlbum4.php?idAnimal=<?= $animal['idAnimal'] ?>">modifier</a>
						<a type="button" class="btn btn-danger mb-2"href = "showAlbums4.php?idAnimal=<?= $animal['idAnimal'] ?>">Supprimer</a>
