...
<body>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="showAlbums2.php">
                ...
                <span class="showAlbums2.php">Sites</span>
              </a>
            </li>
  ...
  <div class="main-content" id="panel">
	...
	<section class="container">
		<h2></h2>
		<a href = "showAlbums4.php" class="btn btn-primary shop-item-button">All animals</a>
		<div class="form-container">
            <form action="" method = 'POST'>
                <div class="row">
                    <div class="col-25">                
                        <label>Veuillez entrer le nom à chercher: </label>
                    </div>
                    <div class="col-75">
                        
                        
                        <input class="controle" type="text" name="animal" required pattern="[0-9a-zA-Z-\.]{3,12}" placeholder="au min 3 caractères">
                    </div>
                </div>
                <br>
                <div class="row">
                    <input type = "submit" class="btn btn-warning"  value = "Rechercher" name ="Rechercher">
                </div>
            </form>
		</div>
	</section>
	...
	<?php
		if (isset($_POST['animal']) && isset($_POST['Rechercher'])){
			$result = $animalA->getAnimalByNom($_POST['animal']);
			if ($result !== false) {
	?>
		<section class="container">
			<h2>Animal</h2>
        ...
        <div class="card" style="width: 18rem;">
				<div class="shop-item">
					<label>Nom: </label><strong class="shop-item-title"> <?= $result['nom'] ?> </strong>
					<img class="card-img-top"src="../.././assets1/img/<?= $result['image'] ?>" class="shop-item-image">
          </div>
					<div class="card-body">
						<strong><label>Age:  </label></strong> <span class="shop-item-price"><?= $result['age'] ?> ans</span>
					</div>
