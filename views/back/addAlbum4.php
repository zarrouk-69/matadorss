<?php
    ...
    require_once 'C:/xampp/htdocs/integration/entities/animal.php';

    $siteS =  new siteS();
    $sites = $siteS -> afficherSite();
    $animalA =  new animalA();

    if (isset($_POST['nom']) && isset($_POST['age']) && isset($_POST['image']) && isset($_POST['site']) && isset($_POST['descriptionA'])) {
        $animal = new animal($_POST['nom'], $_POST['age'], $_POST['image'], $_POST['site'], $_POST['descriptionA']);
         
        
        $animalA->addAnimal($animal);

        header('Location:showAlbums4.php');
    }
?>
  ...
  <div class="main-content" id="panel">
        ...
        <div class="container">
            <div class="row d-flex align-items-center py-5">
                <div class="col-lg-6 text-start">
                    <strong><h1>Animaux</h1></strong>
    <a href = "searchAlbum4.php" class="btn btn-primary shop-item-button">Search</a>
	<section class="container">
		...
		<div class="form-container">
          ...
          <h1>Choisir une zone </h1><select name="site" id="site">
          <?php
                      foreach ($sites as $site) {
          ?>

          <option value="<?= $site['numS'] ?>">
            <?= $site['nomS'] ?>
         </option>
          <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input class="controle" type="text" name="nom" required pattern="[0-9a-zA-Z-\.]{3,12}" placeholder="au min 3 caractères">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input class="controle" type="number" name="age" min="1" max="200" required placeholder="Entre 1 et 200"> 
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type = "textarea" name = "descriptionA" >
                    </div>
                </div>
                <br>
                <div class="row">
