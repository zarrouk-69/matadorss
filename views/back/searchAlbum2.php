...
<!-- Sidenav -->
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="showAlbums2.php">
                ...
                <span class="nav-link-text" href="showAlbums2.php">Sites</span>
              </a>
            </li>
  ...
  <div class="main-content" id="panel">
	...
	<section class="container">
		<h2></h2>
		<a href = "showAlbums2.php" class="btn btn-primary shop-item-button">All sites</a>
		<div class="form-container">
            <form action="" method = 'POST'>
                <div class="row">
                    <div class="col-25">                
                        <label><strong>veuillez entrer le nom à rechercher: </strong></label>
                    </div>
                    <div class="col-75">
                        
                        
                        <input class="controle" type="text" name="site" required pattern="[0-9a-zA-Z-\.]{3,12}" placeholder="au min 3 caractères">
                    </div>
                </div>
                <br>
                <div class="row">
                    <input type = "submit" class="btn btn-warning mb-2" value = "Rechercher" name ="Rechercher">
                </div>
            </form>
		</div>
	</section>
	...
	<?php
		if (isset($_POST['site']) && isset($_POST['Rechercher'])){
			$result = $siteS->getSiteByNomS($_POST['site']);
			if ($result !== false) {
	?>
		<section class="container">
			<h2>Site</h2>
