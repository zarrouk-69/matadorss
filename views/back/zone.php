...
<div class="row">
  <div class="column">
    <img src="../.././assets1/img/a.jpg" style="width:100%" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="../.././assets1/img/camel.jpg" style="width:100%" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="../.././assets1/img/f.jpg" style="width:100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
  </div>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="mySlides">
      ...
      <img src="../.././assets1/img/a.jpg" style="width:100%">
    </div>

    <div class="mySlides">
      <div class="numbertext">2 / 4</div>
      <img src="../.././assets1/img/camel.jpg" style="width:100%">
    </div>

    <div class="mySlides">
      <div class="numbertext">3 / 4</div>
      <img src="../.././assets1/img/f.jpg" style="width:100%">
    </div>
    ...
    <div class="column">
      <img class="demo cursor" src="../.././assets1/img/a.jpg" style="width:100%" onclick="currentSlide(1)" alt="Nature and sunrise">
    </div>
    <div class="column">
      <img class="demo cursor" src="../.././assets1/img/camel.jpg" style="width:100%" onclick="currentSlide(2)" alt="Snow">
    </div>
    <div class="column">
      <img class="demo cursor" src="../.././assets1/img/f.jpg" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
