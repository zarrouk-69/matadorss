		...
		<div class="form-container">
            <form action="" method = "POST">
                <div class="row">
                    ...
                    <div class="col-75">
                        <input class="controle" type="text" name="nomS" required pattern="[0-9a-zA-Z-\.]{3,12}" placeholder="au min 3 caractères">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input class="controle" type="textarea" name="descS"> 
                ...
                <br>
                <div class="row">
                    <input type="submit" class="btn btn-warning mb-2" value="Submit" name = "submit">
                </div>
            </form>
		</div>
	</section>
