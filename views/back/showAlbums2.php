...
require_once 'C:/xampp/htdocs/integration/controller/siteS.php';
	...
	$sitess = $siteS->afficherSite();

if (isset($_POST['Trier']))
  {
$sitess = $siteS->trierSite();
  }
  elseif (isset($_POST['TrierDesc']))
  {
$sitess  = $siteS->trierSiteDesc();
  }  
	...
	if (isset($_GET['numS'])) {
		$siteS->deleteSite($_GET['numS']);
		header('Location:showAlbums2.php');
	}
...
<body>
    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="../.././assets1/img/brand/blue.png" class="navbar-brand-img" alt="...">
        </a>
      </div>
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="showAlbums4.php">
                <i class="ni ni-tv-2 text-primary"></i>
                <span class="nav-link-text">Animaux</span>
              </a>
            </li>
            <li class="nav-item">
  ...
  <div class="main-content" id="panel">
	...
	<a href = "searchAlbum2.php" class="btn btn-warning mb-2">Rechercher</a>
    ...
    <div class="column">
        <h1>Map de La réserve</h1>
<p>Cliquer sur les zones</p>
<img src="../.././assets1/img/maps.jpg" alt="Workplace" usemap="#workmap" width="600" height="400">
<map name="workmap">
  <area shape="rect" coords="34,44,270,350" alt="Computer" href="zone.php">
  <area shape="rect" coords="400,50,22,200" alt="Phone" href="zone1.php">
  <area shape="circle" coords="337,300,44" alt="Cup of coffee" href="showAlbums2.php">
</map>
</div>  
      ...
      <h2>sites</h2>
      <a href = "addAlbum2.php" class="btn btn-primary shop-item-button" href = "#">Ajouter</a>
      <div class="row">
      <meta name="viewport" content="width=device-width, initial-scale=1">
          ...
          <div class="card" style="width: 18rem;">
					<h>Nom: </h><strong> <?= $site['nomS'] ?> </strong>
					<img class="card-img-top" src="../.././assets1/img/<?= $site['imageS'] ?>" width = "200" height = "200" class="shop-item-image">
					</div>
          <div class="card-body">
						<h>Description: </h><span class="shop-item-price"><?= $site['descS'] ?> </span>
						<a type="button" class="btn btn-success mb-2" href = "updateAlbum2.php?numS=<?= $site['numS'] ?>">Modifier</a>
            <a type="button" class="btn btn-danger mb-2" href = "showAlbums2.php?numS=<?= $site['numS'] ?>">Supprimer</a>
					</div>
  ...
  <!-- Optional JS -->
  <script src="../.././assets1/vendor/chart.js/dist/Chart.min.js"></script>
  <script src="../.././assets1/vendor/chart.js/dist/Chart.extension.js"></script>
  <!-- Argon JS -->
