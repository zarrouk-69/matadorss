...
<img src="../.././assets/img/maps.jpg" alt="Workplace" usemap="#workmap" width="600" height="400">
<map name="workmap">
  ...
  <area shape="circle" coords="337,300,44" alt="Cup of coffee" href="showAlbums2.php">
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1">
          ...
          <div class="card" style="width: 18rem;">
					...
					<img class="card-img-top" src="../.././assets/img/<?= $site['imageS'] ?>" width = "200" height = "200" class="shop-item-image">
					</div>
          <div class="card-body">
