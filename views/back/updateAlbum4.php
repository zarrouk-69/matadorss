<?php
    ...
    if (isset($_POST['nom']) && isset($_POST['age']) && isset($_POST['image']) && isset($_POST['site'])) {
        $animal = new animal($_POST['nom'], $_POST['age'], $_POST['image'], $_POST['site']);
        
        $animalA->updateAnimal($animal,$_GET['idAnimal']);
    }
?>
  ...
  <div class="main-content" id="panel">
    ...
    <?php
        if (isset($_GET['idAnimal'])) {
            $result = $animalA->getAnimalById($_GET['idAnimal']);
			if ($result !== false) {
    ?>
    ...
    <div class="form-container">
            <form action="" method = "POST">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type = "text" name = "idSite" value = "<?= $result['idSite'] ?>">
                    </div>
                </div>
                <br>
                <div class="row">
