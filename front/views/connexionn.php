...
if (isset($_POST["adresseU"]) &&
    ...
    {   $message=$userC->connexionUser($_POST["adresseU"],$_POST["mdpU"]);
        ...
        if($message!='pseudo ou le mot de passe est incorrect'){
           header('Location:profileuser.php?e='.$_SESSION['e']);}
        else{
...
window.onclick = function(event) {
    ...
    <section class="service-wrapper py-3">
        <div class="container-fluid pb-3">
            <div class="row">
                <h2 class="h2 text-center col-12 py-5 semi-bold-600">authentification</h2>
   ...
   <div class="message">
    ...
    <table border="0" cellpadding="10" cellspacing="10" width="500" align="center" class="tblLogin">
        ...
        <tr class="tablerow">
            ...
            <td>
                <input type="text" name="adresseU" placeholder="Email" required class="login-input">
            </td>
        </tr>
        <tr class="tablerow">
            <td>
            ...
            <td>
                <input type="password" name="mdpU" placeholder="Password" required class="login-input"></td>
        </tr>
