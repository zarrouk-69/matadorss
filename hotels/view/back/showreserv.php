                    ...
                    <ul class="nav navbar-nav d-flex justify-content-between mx-xl-5 text-center text-dark">
                        <li class="nav-item">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown">
                                <a class="nav-link btn-outline-primary rounded-pill px-3" href="about.html">reserv</a>
                                <div class="dropdown-content">
                                  <a href="showreserv.php">reserv</a>
        ...
        <section class="container">
            ...
            <div class="shop-items">
                ...
                <div class="shop-item">
                  ...
                  <div>
<div class="dropdown2">
  <!--<a  href = "showimage1.php?idreserv=<?= $reserv['idreserv'] ?>"><img src="/hotels/assets/img/<?= $reserv['imagereserv'] ?>" alt="Cinque Terre" width="200" height="200"></a>
  ...
  <div class="desc">Beautiful</div>
    ...
    ?>-->
                    ...
                    <div class="shop-item-details">
                        ...
                        <a type="button" class="btn btn-primary shop-item-button" href = "updatereserv.php?idreserv=<?= $reserv['idreserv'] ?>">Modifier</a>
