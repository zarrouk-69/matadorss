<?php
	...
	$produits = $produitC->triproduitda();
    ...
    if(isset($_POST['submit'])){
        if(!empty($_POST['pet-select'])) {
            $selected = $_POST['pet-select'];
            if($selected=="d"){$produits = $produitC->triproduitd();}
                elseif($selected=="c"){$produits = $produitC->triproduitda();}
        }}
...
<body>
 ...
 <nav id="main_nav" class="navbar navbar-expand-lg navbar-light bg-white shadow">
    ...
    <label for="pet-select">tri</label>

<select name="pets" id="pet-select">
    <option value="">veuillez choisir une option</option>
    <option value="d">tri dec</option>
    <option value="c">tri croi</option>

</select>
    <a href = "showproduitscro.php" class="btn btn-primary shop-item-button">submit </a>
