 ...
 if (test===""&&test2==="") {alert("les deux champs ne doivent pas etre vide")}
	...
	<?php
		if (isset($_POST['hotel']) && isset($_POST['search'])){
			$result = $hotelC->gethotelByTitle($_POST['hotel']);
		...
		<section class="container">
			...
			<div class="shop-items">
				...
				?>
                  ...
                  <div>
<div class="dropdown2">
  <a  href = "showimage1.php?idhotel=<?= $hotel['idhotel'] ?>"><img src="/integration/assets/img/<?= $hotel['imagehotel'] ?>" alt="Cinque Terre" width="200" height="200"></a>
