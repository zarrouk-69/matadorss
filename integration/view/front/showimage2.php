...
<div style="display: inline-block;" class="img-magnifier-container"><img  id="myimage"  src="/integration/assets/img/<?= $result['imagehotel'] ?>" width = "300" height = "300" class="shop-item-image"></div>
<div style="display: inline-block;" class="img-magnifier-container"><img  id="myimage1"src="/integration/assets/img/<?= $result['imagehotel1'] ?>" width = "300" height = "300" class="shop-item-image"></div>
<div style="display: inline-block;" class="img-magnifier-container"><img  id="myimage2"src="/integration/assets/img/<?= $result['imagehotel2'] ?>" width = "300" height = "300" class="shop-item-image"></div>
<div style="display: inline-block;" class="img-magnifier-container"><img  id="myimage3"src="/integration/assets/img/<?= $result['imagehotel3'] ?>" width = "300" height = "300" class="shop-item-image"></div>
<div style="display: inline-block;" class="img-magnifier-container"><img  id="myimage4"src="/integration/assets/img/<?= $result['imagehotel4'] ?>" width = "300" height = "300" class="shop-item-image"></div>
